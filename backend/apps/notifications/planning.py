...
from apps.notifications.formatting import build_notification_message
...
class ReminderPlanningService:
    ...
    def scan() -> dict[str, int | str]:
        ...
        tasks = (
            ...
            .select_related("column", "task_status")
    ...
    def _resolve_reason(
        ...
        if ReminderPlanningService._is_stale_in_progress(task):
        ...
        if ReminderPlanningService._is_stale_planned(task):
    ...
    def _create_notification(
        *,
        ...
        message_text = build_notification_message(task, reason)
